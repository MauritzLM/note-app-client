  ...
  <header>
    ...
    <div class="wrapper">
      <div class="banner">
        <svg xmlns="http://www.w3.org/2000/svg" width="95" height="28" fill="none" viewBox="0 0 95 28">
          <g clip-path="url(#a)">
            ...
            <path class="logo-text" fill="#0E121B"
      ...
      <nav>
        ...
        <RouterLink @click="selected_note.changeDisplay(false)" :class="$route.name === 'search' ? 'cs-active' : ''" to="/search">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            <path class="fill" fill="#0E121B" fill-rule="evenodd"
              ...
              clip-rule="evenodd" />
            <path class="fill" fill="#0E121B" fill-rule="evenodd"
              d="m16.736 15.648 5.616 5.6-1.06 1.063-5.615-5.601 1.06-1.062Z" clip-rule="evenodd" />
          </svg>
          <span>Search</span>
        </RouterLink>
        ...
        <RouterLink :class="$route.name === 'settings' ? 'cs-active' : ''" to="/settings">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            <path class="fill" fill="#0E121B" fill-rule="evenodd"
...
header {
  ...
  nav {
    ...
    bottom: 0;
    left: 0;
    box-shadow: 0px -4px 6px var(--boxShadowColor);
    width: 100%;
    z-index: 100;
    background-color: var(--bodyBackgroundColor);
    ...
    a {
      ...
      .stroke {
        stroke: var(--textColorAlt4);
      }

      .fill {
        fill: var(--textColorAlt4);
      }
    }
