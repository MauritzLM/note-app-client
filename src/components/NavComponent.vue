...
<template>
  <header>
    ...
    <div class="wrapper">
      ...
      <nav>
        <RouterLink @click="selected_note.changeDisplay(false)" :class="$route.params.list === 'all' ? 'cs-active' : ''"
          to="/all/all">
        ...
        <RouterLink @click="selected_note.changeDisplay(false)"
          :class="$route.params.list === 'archived' ? 'cs-active' : ''" to="/archived/archived">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <RouterLink @click="selected_note.changeDisplay(false)"
          :class="$route.params.list === 'search' ? 'cs-active' : ''" to="/search/search">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            <path fill="#0E121B" fill-rule="evenodd"
        ...
        <RouterLink @click="selected_note.changeDisplay(false)"
          :class="$route.params.list === 'tags' ? 'cs-active' : ''" to="/tags/tags">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
header {
  ...
  nav {
    ...
    bottom: 0;
    left: 0;
    box-shadow: 0px -4px 6px #f0f0f09d;
    width: 100%;
    z-index: 100;
    background-color: var(--bodyBackgroundColor);
    ...
    .cs-active {
      background-color: var(--selectedSurface);
